...
const inputSchema = {
  type: "object",
  properties: {
    action: { type: "string", enum: ["create", "snapshot", "node", "wait", "cancel", "retry", "resume", "approve", "reject", "amend"] },
    run_id: { type: "string" },
    node_id: { type: "string" },
    note: { type: "string" },

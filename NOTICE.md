...
Iolaus is a modified derivative of portions of oh-my-openagent (formerly oh-my-opencode).

- Original project: https://github.com/code-yeongyu/oh-my-openagent
- Source checkout: https://github.com/Ephemushroom/oh-my-openagent
- Source commit: `598cb66580bebaf39c5ea20ee4bef6cb7a906777`
- Original license: Sustainable Use License, Version 1.0, reproduced in `LICENSE.md`.
...
There is no automatic upstream update mechanism. URLs here identify provenance, not synchronization endpoints.

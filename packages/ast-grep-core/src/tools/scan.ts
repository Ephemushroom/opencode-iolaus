...
/** Iolaus: same veto seam as RewriteHooks; a returned string blocks the mutation pass. */
export interface ScanHooks {
  readonly onPreviewComplete?: (matches: readonly ScanMatch[]) => void | string | Promise<void | string>;
}
...
export async function executeScan(
  ...
  if (typeof vetoed === "string") return failure("PERMISSION_DENIED", vetoed, "apply", elapsed(), { stderr: preview.stderr });
